                ...
                <div class="row less-gutter">
                        ...
                        <div class="panel-btn">
                            <a class="btn btn-sm btn-info"
                                href="{{ URL::route('unhls_test.getAddIsolateTest', [$isolate->id]) }}">
                                <span class="glyphicon glyphicon-plus-sign"></span>
                                Add New Test
                            </a>
                            <a class="btn btn-sm btn-default" href="{{ URL::to('visitreport/'.$isolate->id.'/print') }}"
                                target="_blank">
                                    ...
                                    <table class="table table-hover table-condensed">
                                        ...
                                        <tbody>
                                            <tr>
                                                ...
                                                <td>
                                                    <!-- Specimen statuses -->
                                                    @if($isolate->isRejected())
                                                        Rejected                                                    
                                                    @elseif($isolate->isAccepted())
                                                        Accepted
                                                    @endif
                                                </td>
                                                <td>
                                                {{ $isolate->facility->name }}
                                                </td>
                                            </tr>
                                        </tbody>
                                    </table>
                ...
                @foreach($testSet as $key => $test)
                   <!-- <tr 
                        ...
                        @if ($test->isNotReceived()) 
                            ...
                            @endif
                        @endif
                        @if ($test->isolate->isAccepted() && !($test->isVerified()))
                            @if(Auth::user()->can('reject_test_specimen') && !($test->isolate->isReferred()))
                                @if(!($test->isolateIsRejected()))
